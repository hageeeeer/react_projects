        ...
        <div className="collapse navbar-collapse" id="collapsibleNavId">
          ...
          <ul className="navbar-nav ms-auto mt-2 mt-lg-0">
           ...
           {!user?<>
            ...
            <li className="nav-item position-relative" data-bs-toggle={!user?"modal":''} data-bs-target="#exampleModal"  onClick={()=>{setIsOpen(true)}}>
              <Link className="nav-link" to="cart"
              >
                <i className="fa-solid fa-cart-shopping"></i>
              </Link>
              <span className='d-inline-block cart d-flex justify-content-center align-items-center position-absolute  rounded-circle '>{(data?.data?.numOfCartItems)?data?.data?.numOfCartItems:0}</span>
            </li>
